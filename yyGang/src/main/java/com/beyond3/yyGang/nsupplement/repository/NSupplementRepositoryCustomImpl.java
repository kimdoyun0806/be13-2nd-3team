...
import com.beyond3.yyGang.hfunction.QHFunctionalCategory;
import com.beyond3.yyGang.hfunction.QHFunctionalItem;
import com.beyond3.yyGang.ingredient.IngredientName;
import com.beyond3.yyGang.ingredient.QIngredient;
import com.beyond3.yyGang.ingredient.QIngredientCategory;
...
public class NSupplementRepositoryCustomImpl implements NSupplementRepositoryCustom {
    ...
    public PageResponseDto<NSupplementResponseDtoV2> searchPageV2(NSupplementSearchRequestDtoV2 searchRequest, Pageable pageable, SortType sortType) {
        ...
        for (Tuple tuple : hFuncCateTuple) {
            ...
            HFunctionName name = tuple.get(hFunctionalItem.healthName);
            if (dto != null && name != null) {
                dto.addHealthName(name);
            }
        }
        ...
        for (Tuple tuple : ingrCateTuple) {
            ...
            IngredientName name = tuple.get(ingredient.ingredientName);
            if (dto != null && name != null) {
                dto.addIngredient(name);
            }
        }
...
//        return null;
    ...
    private BooleanExpression productNameContains(String productName) {
        ...
        return StringUtils.hasText(productName) ? nSupplement.productName.containsIgnoreCase(productName) : null;
